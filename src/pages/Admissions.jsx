    ...
    <div className="page-root">
      ...
      <section className="hero-section">
        ...
        <div className={`hero-content ${isLoaded ? 'hero-content--visible' : 'hero-content--hidden'}`}>
          <h1 className="hero-heading animate-fade-in-up delay-100">Admissions</h1>
      ...
      {/* ── Gradient Transition ── */}
      <div className="dark-to-navy-transition"></div>
          ...
          <div className={`vault-panel ${isVaultOpen ? 'vault-panel--open' : 'vault-panel--closed'}`}>
            ...
            <div className="vault-panel-header">
              <div className="vault-panel-header-left">
                ...
                <span className="vault-path">root/admissions/documents/</span>
              </div>
            ...
            <div className="vault-rows">
              {pdfDocuments.map((doc, i) => (
                <div
                  key={doc.id}
                  className={`vault-row ${isVaultOpen ? 'vault-row--visible' : 'vault-row--hidden'}`}
            ...
            <div className="vault-panel-footer">
              <span className="vault-footer-status">
      ...
      <style>{`
        ...
        /* ─── Dark → Navy Transition ─── */
        .dark-to-navy-transition {
          height: 12rem;
          background: linear-gradient(to bottom, #0a0a0a, #050b14);
          width: 100%;
          position: relative;
          z-index: 10;
        }
        ...
        @media (min-width: 768px) { .vault-hover-label { font-size: 0.75rem; } }
        ...
        .vault-row--hidden  { opacity: 0; transform: translateX(-1rem); }
        .vault-row--visible { opacity: 1; transform: translateX(0); }
        ...
        @media (min-width: 768px) { .vault-row-name { font-size: 1rem; } }
